...
Usage:
    python .codex/skills/quality-auditor/scripts/cli.py pipeline-readiness --project tech_ai_semiconductor
    python .codex/skills/quality-auditor/scripts/cli.py pipeline-readiness --project tech_ai_semiconductor --json
...
def scan_evidence_schema_readiness(
    ...
    try:
        from quality_auditor.evidence_schema import (
...
def scan_output_schema_readiness(
    ...
    try:
        from quality_auditor.output_schema import (
...
def scan_mock_output_readiness(
    ...
    try:
        from quality_auditor.mock_outputs import (
...
def scan_generator_preview_readiness(
    ...
    try:
        from quality_auditor.generator_previews import (
    ...
    writer_paths = [
        WORKSPACE_ROOT / ".codex" / "skills" / "research-writer" / "src" / "research_writer" / "output_writers.py",
        WORKSPACE_ROOT / "investment_system" / "pipelines" / "sector_research" / "output_writers.py",
    ]
    writer_content = "\n".join(
    ...
    writer_file = ".codex/skills/research-writer/src/research_writer/output_writers.py"
