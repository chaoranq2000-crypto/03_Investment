...
|---|---|---:|---:|---:|---:|---:|---:|---|
| high_speed_optical_modules | 23 | 9 | 0 | 0 | 0 | 6 | card_markdown, company_overrides, comparison_override, description, grade, logs, source_rows, sub_theme |
...
- `UNUSED_SOURCE` (`investment_system/research/evidence/high_speed_optical_modules.yaml`): source_id 'LEGACY-DISABLED-001-20260619' is defined but never referenced by any evidence_item.
...
|---|---|---:|---:|---:|
| high_speed_optical_modules | 23 | 23 | 0 |
