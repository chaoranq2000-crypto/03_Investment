...
- `seed/`: initial taxonomy and workflow seed documents.
- `plans/`: living plans and historical planning records.
- `audits/`: audit reports, change summaries, and legacy migration records.
- `state/`: selected live YAML state/config snapshots for orientation.
- `external/`: selected external test summaries that are useful for setup context.
