...
Usage:
    python -m investment_system.pipelines.sector_research.audit_evidence_coverage --project tech_ai_semiconductor
    python -m investment_system.pipelines.sector_research.audit_evidence_coverage --project tech_ai_semiconductor --priority P0,P1
    python -m investment_system.pipelines.sector_research.audit_evidence_coverage --project tech_ai_semiconductor --output
    python -m investment_system.pipelines.sector_research.audit_evidence_coverage --project tech_ai_semiconductor --markdown
    python -m investment_system.pipelines.sector_research.audit_evidence_coverage --project tech_ai_semiconductor --csv
...
def main() -> int:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python -m investment_system.pipelines.sector_research.audit_evidence_coverage "
