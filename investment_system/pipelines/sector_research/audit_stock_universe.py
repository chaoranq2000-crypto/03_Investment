...
Usage:
    python -m investment_system.pipelines.sector_research.audit_stock_universe --project tech_ai_semiconductor
    python -m investment_system.pipelines.sector_research.audit_stock_universe --project tech_ai_semiconductor --json
    python -m investment_system.pipelines.sector_research.audit_stock_universe --project tech_ai_semiconductor --include-pending
...
def main() -> int:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python -m investment_system.pipelines.sector_research.audit_stock_universe "
